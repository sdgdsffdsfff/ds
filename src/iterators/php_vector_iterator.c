...
{
    ds_vector_iterator_t *iterator = (ds_vector_iterator_t *) i;
...
static zend_object_iterator *ds_vector_create_iterator(
    ...
    iterator = ecalloc(1, sizeof(ds_vector_iterator_t));
...
zend_object_iterator *ds_vector_get_iterator_ex(zend_class_entry *ce, zval *obj, int by_ref, ds_vector_t *vector)
{
